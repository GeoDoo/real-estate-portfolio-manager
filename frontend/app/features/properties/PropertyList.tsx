          ...
          data.map(async (property) => {
            ...
            if (
              ...
              !requiredFields.every((f) => {
                const val = (
                  valuation as unknown as Record<
                    string,
                        ...
                        <div className="absolute top-4 right-4 z-30 flex items-center gap-2">
                          <InfoTooltip
                            label={
                              ...
                              >
                                {ribbon.status === "buy" ? "BUY" : "DO NOT BUY"}
                              </div>
                            }
                            tooltip={
                              <>
                                <div>
                                  ...
                                  >
                                    {ribbon.npv !== undefined
                                      ? formatCurrency(ribbon.npv)
                                      : "N/A"}
                                  </span>
                                  <br />
                                  <b>IRR:</b>{" "}
                                  ...
                                  >
                                    {ribbon.irr !== undefined
                                      ? ribbon.irr.toFixed(2) + "%"
                                      : "N/A"}
                                  </span>
                                </div>
                                <div className="mt-2 text-xs text-gray-200">
                                  <b>NPV</b>: Net Present Value. A positive NPV
                                  means the investment is expected to be
                                  profitable.
                                  <br />
                                  <b>IRR</b>: Internal Rate of Return. Higher
                                  IRR generally means a better investment.
                                </div>
                              </>
                            }
                          />
