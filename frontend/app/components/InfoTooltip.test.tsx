...
describe("InfoTooltip", () => {
  ...
  describe("rendering", () => {
    it("renders label correctly", () => {
      render(<InfoTooltip label="Click me" tooltip="This is a tooltip" />);
    ...
    it("renders with custom className", () => {
      render(
        <InfoTooltip label="Test" tooltip="Tooltip" className="custom-class" />,
      );

      // The outermost span is the first span in the document with the class
      const allSpans = document.querySelectorAll("span");
      const outerSpan = Array.from(allSpans).find((span) =>
        span.className.includes("custom-class"),
      );
    ...
    it("renders React element as label", () => {
      ...
      render(
        <InfoTooltip label={<LabelComponent />} tooltip="Tooltip content" />,
      );
  ...
  describe("interactions", () => {
    it("shows tooltip on mouse enter", async () => {
      ...
      render(<InfoTooltip label="Hover me" tooltip="Tooltip content" />);
    ...
    it("shows tooltip on focus", () => {
      render(<InfoTooltip label="Focus me" tooltip="Tooltip content" />);
  ...
  describe("accessibility", () => {
    it("has proper tabindex for keyboard navigation", () => {
      render(<InfoTooltip label="Accessible" tooltip="Tooltip" />);
    ...
    it("supports keyboard navigation", () => {
      render(<InfoTooltip label="Keyboard" tooltip="Tooltip" />);
  ...
  describe("event listeners", () => {
    it("adds scroll and resize listeners when tooltip is shown", async () => {
      ...
      render(<InfoTooltip label="Test" tooltip="Tooltip" />);
